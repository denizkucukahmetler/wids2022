...
!(function($) {
 ...
 $(document).ready(function() {
		...
		"en": {
			...
			"register" : "Regıster",
			"abo" : "<br /> <br /> <br /> <br /> WiDS Istanbul is a technical conference that aims to inspire, educate and support women in data science. Organized for the first time by <a id='stanf_link' class='cta-btn' href='https://www.stanford.edu/' target='blank'> Stanford University </a> in 2015, it turned into a worldwide conference with 150+ regional events in more than 60 countries, reaching 100,000 participants annually online and in person. <br /> <br /> WiDS Istanbul is an independent event, organized by WiDS Istanbul <a href='#ambassadors'>ambassadors</a> and <a id='sabanci_link' class='cta-btn' href='https://www.sabanciuniv.edu/en/' target='blank'> Sabancı University </a> <a id='verim_link' class='cta-btn' href='https://verim.sabanciuniv.edu/en' target='blank'> VERIM</a>. It will be held online on May 21, 2022.  <br /> <br />  All genders are invited to attend WiDS events, which feature outstanding women doing outstanding work.",
      "amb": "Ambassadors",
      ...
      "ambass2": "Ambassadors",
      "supporters2": "Communıcatıon Supporters",
      "supporters3": "Hosts",
      "program":'<h3>Program Stream</h3><a id="program_link" class="cta-btn" href="https://drive.google.com/file/d/1CH0b7bEzGk4NpdJGAycj79cswMPcs89Z/view?usp=sharing" target="blank">Download program stream</a>',
